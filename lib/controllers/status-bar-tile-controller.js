...
export default class StatusBarTileController {
  ...
  async fetchRepositoryData(repository) {
    ...
    const remoteName = branchName ? await repository.getRemoteForBranch(branchName) : null;
    ...
    const data = {
      ...
      remoteName,
      aheadCount: branchName ? await repository.getAheadCount(branchName) : null,
      behindCount: branchName ? await repository.getBehindCount(branchName) : null,
