...
import DiscardHistory from './file-discard-history';
...
export default class Repository {
  ...
  storeBeforeAndAfterBlobs(filePath, isSafe, destructiveAction, {partial} = {}) {
    return this.discardHistory.storeBlobs(filePath, isSafe, destructiveAction, partial);
  }

  undoLastDiscardInTempFile(filePath, isSafe, {partial} = {}) {
    return this.discardHistory.undoLastDiscardInTempFile(filePath, isSafe, partial);
  }

  popUndoHistoryForFilePath(filePath) {
    return this.discardHistory.popUndoHistoryForFilePath(filePath);
  }

  hasUndoHistory(filePath, {partial} = {}) {
    return this.discardHistory.hasUndoHistory(filePath, partial);
  }
  ...
  clearPartialDiscardHistoryForPath(filePath) {
    return this.discardHistory.clearPartialDiscardHistoryForPath(filePath);
  }

  clearDiscardHistory() {
    return this.discardHistory.clearDiscardHistory();
  }

  @autobind
  getPartialDiscardUndoHistoryForPath(filePath) {
    return this.discardHistory.getPartialDiscardUndoHistoryForPath(filePath);
  }
