  ...
  renderTokenInput() {
    return (
      <form className="github-GithubLoginView-Subview" onSubmit={this.handleSubmitToken}>
        ...
        <input
          type="text"
          className="TextInput native-key-bindings"
          placeholder="Enter your token..."
          value={this.state.token}
          onChange={this.handleTokenChange}
        />
        <div>
          <button type="button" onClick={this.handleCancelTokenClick} className="Button icon inline-block-tight">
            Cancel
          </button>
          <input
            type="submit"
            value="Login"
            onClick={this.handleSubmitTokenClick} className="Button Button--primary icon icon-check inline-block-tight"
          />
        </div>
      </form>
    );
