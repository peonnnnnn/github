    ...
    return (
      <div className="github-Dialog github-Credentials modal native-key-bindings">
        ...
        <main className="github-DialogInputs">
          {this.props.includeUsername ? (
            <label className="github-DialogLabel">
              ...
              <input
                ...
                className="TextInput github-CredentialDialog-Username"
          ...
          <label className="github-DialogLabel">
            ...
            <input
              ...
              className="TextInput github-CredentialDialog-Password"
        ...
        <footer className="github-DialogButtons">
          <button className="Button github-CancelButton" tabIndex="3" onClick={this.cancel}>Cancel</button>
          <button className="Button Button--primary" tabIndex="4" onClick={this.confirm}>Sign in</button>
        </footer>
      </div>
    );
  }
