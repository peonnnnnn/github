  ...
  renderLargeDiffMessage() {
    return (
      <div className="large-file-patch">
        ...
        <button className="Button Button--primary" onClick={this.props.handleShowDiffClick}>Show Diff</button>
      </div>
    );
  }
    ...
    return (
      <span className="ButtonGroup">
        {this.props.hasUndoHistory && unstaged ? (
          <button
            className="ButtonGroup-item Button icon icon-history"
        ...
        {this.props.isPartiallyStaged || !this.props.hunks.length ? (
          <SimpleTooltip
            ...
            <button
              className={cx('ButtonGroup-item Button', 'icon', {'icon-tasklist': unstaged, 'icon-list-unordered': !unstaged})}
        ...
        <SimpleTooltip
          ...
          title="Open File">
          <button
            className="ButtonGroup-item Button icon icon-code"
            onClick={this.openFile}
          />
        </SimpleTooltip>
        {this.props.hunks.length ? (
          <button
            className={cx('ButtonGroup-item Button', 'icon', {'icon-move-down': unstaged, 'icon-move-up': !unstaged})}
        ...
        <div className="github-FilePatchView-metaContainer">
          <header className="github-FilePatchView-metaHeader">
            ...
            <div className="github-FilePatchView-metaControls">
              <button
                className={cx('Button', 'icon', {'icon-move-down': unstaged, 'icon-move-up': !unstaged})}
