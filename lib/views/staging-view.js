...
export default class StagingView {
  constructor (props) {
    ...
    this.multiList = new MultiList([this.props.unstagedChanges, this.props.stagedChanges], this.didSelectFilePatch.bind(this))
  ...
  getListTypeForIndex (index) {
    return index === 0 ? ListTypes.UNSTAGED : ListTypes.STAGED
  }
