...
import GithubPanel from './controllers/github-panel'
...
export default class GithubPackage {
  ...
  renderGithubPanel () {
    // if (!this.githubPanel) {
    //   this.githubPanel = document.createElement('div')
    //   this.githubPanel.classList.add('github-panel-gh-info-container')
    // }
    //
    // ReactDOM.render(
    //   <GithubPanel
    ...
    // )
    //
    // this.workspace.addRightPanel({item: this.githubPanel})
    if (!this.githubPanel) {
      this.githubPanel = new GithubPanel({
        repository: null,
        workspace: this.workspace,
        commandRegistry: this.commandRegistry,
        notificationManager: this.notificationManager
