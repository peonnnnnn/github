...
export default class Repository {
  ...
  static absent() {
    return new Repository(null, null, {[initialStateSym]: Absent});
  }

  static loadingGuess() {
    return new Repository(null, null, {[initialStateSym]: LoadingGuess});
  }

  static absentGuess() {
    return new Repository(null, null, {[initialStateSym]: AbsentGuess});
  }
